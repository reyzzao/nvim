...
----  @desuso - nao to usando explorer neo-tree no modo float / flutuante no momento
-- --- Sincroniza o diretorio de trabalho ---
-- -- Este autocomando garante que o terminal flutuante abra no diretorio do arquivo que esta sendo editado
